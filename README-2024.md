# PIPELINE DE DADOS DE VENDAS 2024
...
## Estrutura de arquivos [ALTERADO]
```
root [formacao-engenharia-dados-desafio]
|
+- ./edge
    +- vendas.csv
    +- ...
...
`mkdir -p ./edge ./dataset/raw ./dataset/gold ./app ./scripts/pre_process ./scripts/process ./scripts/hql`
...
run.sh
01
transfer_from_server_2_local_edge.sh 
02
move_from_edge_2_local_raw.sh 
03
move_from_raw_2_hdfs_raw.sh 
04
create_tables_from_hdfs_raw.sh
05
...
touch 
run.sh transfer_from_server_2_local_edge.sh  move_from_edge_2_local_raw.sh  move_from_raw_2_hdfs_raw.sh  create_tables_from_hdfs_raw.sh load_from_hive_2_hdfs_gold.sh move_from_hdfs_gold_2_local_gold.sh
